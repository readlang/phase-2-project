...
function GoalAdd({ newGoal, setNewGoal, saveGoal }) {
	...
	console.log("path", window.location.pathname === "/goals" ? "true" : "false" )
    ...
    return(
        <div id="goalAdd">
            ...
            <form onSubmit={handleSubmit}>
				...
				<label>Interval: </label>	<select id="interval" name="interval" value={newGoal.interval} onChange={(e)=> setNewGoal({...newGoal, interval:e.target.value}) }>
